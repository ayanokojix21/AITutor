...
const LandingPage = () => {
  useEffect(() => {
    ...
    document.body.className = "font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 antialiased overflow-x-hidden selection:bg-primary/30 selection:text-white";
    return () => {
...
<a className="hidden text-sm font-medium text-slate-300 transition-colors hover:text-white md:block" href="#">Sign In</a>
<button className="flex items-center justify-center rounded-lg bg-primary hover:bg-primary-dark px-4 py-2 text-sm font-semibold text-white transition-all shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                Get Started
            </button>
</div>
</div>
...
<button className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-white text-background-dark px-6 py-3.5 text-base font-bold shadow-lg shadow-white/10 hover:bg-slate-200 transition-all">
...
<button className="rounded-xl bg-primary px-8 py-3 text-base font-bold text-white shadow-lg shadow-primary/25 hover:bg-primary-dark transition-all">
